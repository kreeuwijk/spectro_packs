{{- define "csm-operator.powerflexVersion" -}}
  {{- if eq .version "v2.8.0" -}}
    ...
    {{- if eq .lookup "resiliency-config" }}v1.7.0{{ end }}
    {{- if eq .lookup "resiliency-image-podmon" }}v1.7.0{{ end }}
  {{- else if eq .version "v2.7.0" -}}
    ...
    {{- if eq .lookup "repl-image-controller" }}v1.5.0{{ end }}
    {{- if eq .lookup "repl-image-init" }}v1.0.1{{ end }}
    {{- if eq .lookup "resiliency-config" }}v1.6.0{{ end }}
    {{- if eq .lookup "resiliency-image-podmon" }}v1.6.0{{ end }}
